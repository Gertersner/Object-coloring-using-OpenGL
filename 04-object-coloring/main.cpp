...
void init(void)
{
    shader = new Shader("../04-object-coloring/vertex_shader.glsl" ,
                        "../04-object-coloring/fragment_shader.glsl" );
...
main(int argc, char** argv)
{
    ...
    GLFWwindow* window = cs4722::setup_window("Object Coloring", .6, 1);
